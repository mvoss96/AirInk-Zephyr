...
/** Wake the SCD41 (0x36F6, sent twice because it is NACKed while asleep). */
...
/** Create one big DSEG7 number, used to make the refresh do real work.
 *
 * @param scr the active screen
 * @param x   left edge in pixels
 * @param y   top edge in pixels
 * @return the new label, showing "000"
 */
...
/** Exercise the consumer selected by TEST_MODE, forever.
 *
 * @return 0 if the mode cannot run (no display); otherwise never returns
 */
int main(void)
{
