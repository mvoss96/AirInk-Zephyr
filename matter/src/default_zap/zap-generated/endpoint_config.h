...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x0000000D, 4, ZAP_TYPE(INT32U), ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* BatTimeRemaining */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 14, 225 }, \
  { ZAP_CLUSTER_INDEX(14), 3, 12 }, \
  { ZAP_CLUSTER_INDEX(17), 3, 12 }, \
  { ZAP_CLUSTER_INDEX(20), 4, 4 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x00000016,4},{0x00000302,2},{0x00000307,2},{0x0000002C,1}}
